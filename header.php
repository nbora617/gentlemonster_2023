        ...
        <div class="right">
            ...
            <form action="#" method="get" id="searchFrm">
                <fieldset>
                    ...
                    <input type="search" id="searchTxt" placeholder="상품명을 입력해주세요">
        ...
        <div id="open_nav">
            ...
            <div class="swiper" id="nav_adver">
                <div class="swiper-wrapper">
                    <div class="swiper-slide"><a href="#">나에게 어울리는 제품을 찾으세요? 실시간 라이브 채팅으로 제품 추천을 받아보세요.</a></div>
                    <div class="swiper-slide"><a href="#">선물하기 서비스를 통해 소중한 분에게 마음을 전하세요.</a></div>
                    <div class="swiper-slide"><a href="#">무료 배송 반품 서비스로 젠틀몬스터의 서비스를 경험하세요.</a></div>
                </div>
